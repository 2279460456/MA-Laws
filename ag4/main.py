...
class CourtAgents:
    def __init__(self):
        ...
        self.team = SelectorGroupChat(
            ...
            max_selector_attempts=6,
        )

    def candidate_func(self, history):
        """
        自定义发言者选择逻辑：
        阶段 1（聚焦）： presidingJudge_focus
        阶段 2（辩论）： presidingJudge_debate + plaintiffTeam + defendantTeam
        阶段 3（审判）： presidingJudge_final
        """
...
async def main():
    ...
    out_dir = "ag4_output/Qwen3-8B/10.23_20轮"
